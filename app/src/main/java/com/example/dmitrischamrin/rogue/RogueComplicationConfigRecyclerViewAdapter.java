...
import com.example.dmitrischamrin.rogue.RogueData.*;
import com.example.dmitrischamrin.rogue.ColorSelectionActivity;

import static com.example.dmitrischamrin.rogue.ColorSelectionActivity.EXTRA_SHARED_PREF;

public class RogueComplicationConfigRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = "CompConfigAdapter";

    /**
     * Used by associated watch face ({@link Rogue}) to let this
    ...
    public RogueComplicationConfigRecyclerViewAdapter(
            Context context,
...
//                AnalogComplicationWatchFaceService.getComplicationId(ComplicationLocation.LEFT);
        mRightComplicationId =
                Rogue.getComplicationId(ComplicationLocation.RIGHT);
...
//            mLeftComplication.setOnClickListener(this);
        ...
        private void launchComplicationHelperActivity(
            ...
            mSelectedComplicationId =
                    Rogue.getComplicationId(complicationLocation);
            ...
            if (mSelectedComplicationId >= 0) {
                ...
                int[] supportedTypes =
                        Rogue.getSupportedComplicationTypes(
                                complicationLocation);

                ComponentName watchFace =
                        new ComponentName(
                                currentActivity, Rogue.class);
                ...
                currentActivity.startActivityForResult(
                        ComplicationHelperActivity.createProviderChooserHelperIntent(
                                ...
                                mSelectedComplicationId,
                                supportedTypes),
                        RogueConfigActivity.COMPLICATION_CONFIG_REQUEST_CODE);
...
//            mLeftComplicationBackground.setVisibility(View.INVISIBLE);
        ...
        public void initializesColorsAndComplications() {
            ...
            String highlightSharedPrefString = mContext.getString(R.string.saved_marker_color);
            int currentHighlightColor = mSharedPref.getInt(highlightSharedPrefString, Color.rgb(112,253,16));
            ...
            final int[] complicationIds = Rogue.getComplicationIds();
        ...
        public void onClick(View view) {
            ...
            if (mLaunchActivityToSelectColor != null) {
                ...
                activity.startActivityForResult(
                        launchIntent,
                        RogueConfigActivity.UPDATE_COLORS_CONFIG_REQUEST_CODE);
            }
        }
    }
