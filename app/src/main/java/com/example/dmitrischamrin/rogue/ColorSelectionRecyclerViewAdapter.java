...
public class ColorSelectionRecyclerViewAdapter extends
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        RecyclerView.ViewHolder viewHolder =
                new ColorViewHolder(LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.color_config_list_color_item_vektor, parent, false));
    ...
    public class ColorViewHolder extends RecyclerView.ViewHolder
        ...
        private ImageView mColorCircleImageView;


        public ColorViewHolder(final View view) {
            super(view);
            mColorCircleImageView =  view.findViewById(R.id.more_options_image_view_vektor);
        ...
        public void setColor(int color) {
            ...
            mColorCircleImageView.setColorFilter(color);
